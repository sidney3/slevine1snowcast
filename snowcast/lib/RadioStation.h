...
{
private:
    std::reference_wrapper<const std::unordered_map<station_id_t, std::string>> m_stationFiles;
...
public:
    RadioStation(const std::unordered_map<station_id_t, std::string> &stationFiles, TimepointT startTime, DurationT tickDuration, size_t bytesPerTick);
    bool active() const;
