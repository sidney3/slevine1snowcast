...
public:
    ClientConnection(UDPStreamT &&UDPConn, TCPStreamT &&TCPConn, RadioStationT radioStation)
    {

    }
    static ClientConnection make(TCPStreamT &&clientConn, RadioStationT radioStation)
    {
